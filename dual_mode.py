...
if st.session_state.rounds:
    ...
    # Slice last 10 rounds only for prediction
    ...
    if len(df) == 10:
        ...
        if len(X) > 0:
            ...
            st.warning("⚠️ Need at least 4 rounds of sequence to train.")
    else:
        st.info("ℹ️ Add at least 10 rounds to enable prediction.")
else:
